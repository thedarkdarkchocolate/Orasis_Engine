...
layout(set = 0, binding = 0, input_attachment_index = 0) uniform subpassInput gPosition;
layout(set = 1, binding = 1, input_attachment_index = 1) uniform subpassInput gNormal;
layout(set = 2, binding = 2, input_attachment_index = 2) uniform subpassInput gAlbedo;
